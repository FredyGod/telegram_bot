...
token='5517572591:AAF8CoiOsidS0sgTA540gTSyjnk96vhs3N0'
...
def callback_inline(call):
    ...
    if call.message:
        ...
        if call.data=="5":
            bot.send_message(
                chat_id=call.message.chat.id,
                text="Бабушка две недели играла с внуком в школу. К концу второй недели она узнала, что делает за него домашнее задание.",
                reply_markup=keyboard)
